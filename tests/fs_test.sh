if [ "$1" == "1" ]; then
...
elif ["$1" == "6"]; then # Stress Test
    ./run.sh create run.sh run.sh
    ./run.sh append run.sh run.sh
    ./run.sh merge run.sh
    ./run.sh append run.sh run.sh
    ./run.sh merge run.sh
    ./run.sh append run.sh run.sh
    ...
    ./run.sh create test_files/TrafficSigns_10000 TrafficSigns_10000
    ./run.sh append test_files/TrafficSigns_10000 TrafficSigns_10000
    ./run.sh merge TrafficSigns_10000
    ./run.sh append test_files/TrafficSigns_10000 TrafficSigns_10000
    ./run.sh merge TrafficSigns_10000
    ./run.sh append test_files/TrafficSigns_10000 TrafficSigns_10000
    ./run.sh merge TrafficSigns_10000
